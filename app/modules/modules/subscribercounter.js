...
MODULES.moduleClasses["casterlabs_subscriber_counter"] = class {

    constructor(id) {
        this.namespace = "casterlabs_subscriber_counter";
        this.displayname = "caffeinated.subscriber_counter.title";
        ...
        if (userdata) {
            MODULES.emitIO(this, "event", `
                <span style="font-size: ${this.settings.font_size}px; color: ${this.settings.text_color};">
                    ${userdata.streamer.subscriber_count}
                </span>
            `, socket);
        } else {
